...
@Autonomous(name = "BlueUpperParkRight", group = "Linear Opmode")
public class BlueUpperParkRight extends LinearOpMode {
...
//        FNM.setDirection(Servo.Direction.FORWARD);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //false = up
        drive(1, 50,0.9);
        drive(3,72,0.9);//was 77 cm
        drive(3,5,0.15); //slow to the foundetion
